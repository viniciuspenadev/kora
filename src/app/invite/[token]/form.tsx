  ...
  function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    startTransition(async () => {
      ...
      if (result?.isNewUser && password) {
        ...
        // Confiança foi semeada no acceptInvite (usuário novo) → vem ticket
        // direto. Se falhou (raro), vem "challenge" (código já enviado); manda
        // pro signin com e-mail preenchido em vez de mostrar "falhou".
