...
const BLOCKED_NOTICE: Record<string, string> = {
  ...
  // 🔒 Quem lê isto é o ATENDENTE (owner e admin entram pra resolver). Duas regras na
  //    redação: não dizer "senha inválida" — ele acertou a senha, e mandá-lo trocar de
  //    senha é o que fazia a equipe achar que perdeu a conta; e **não contar a situação
