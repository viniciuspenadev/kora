...
export type FlowNodeType =
  ...
  // 🔴 O nó "assign" (Distribuir conversa, round-robin) foi REMOVIDO em 2026-08-26 junto
  //    com o motor de distribuição automática. Decisão do dono: o roteamento passa a ser
  //    responsabilidade do nó `transfer`, desenhado pelo cliente, em vez de um motor
  //    paralelo que competia com o fluxo. Medido antes de remover: 0 de 17 fluxos usavam.
...
export type TransferTarget = "department" | "agent" | "owner" | "pool" | "round_robin"
...
export interface TransferNodeConfig {
  ...
  agentId?:    string
  /** Ordered selected-agent pool; no department required. */
  agentIds?:   string[]
  summary?:   string
  handoff?:   string
