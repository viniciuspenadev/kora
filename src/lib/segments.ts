// Segmentos de negócio (verticais) — PT-BR. Lista fornecida pelo owner (diretório
// clássico de segmentos). Flat + busca simples (não agrupada). O valor gravado é o
// texto do segmento (tenant_companies.segment); o usuário também pode digitar um
// valor fora da lista ("usar assim mesmo") — completo, mas não restritivo.
