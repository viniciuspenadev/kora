...
import { TemplatePreview, countVars } from "./template-preview"
...
export function TemplateBuilder({ onClose, onDone }: { onClose: () => void; onDone: (msg: string) => void }) {
  ...
  const headerHasVar = countVars(headerText) > 0

  function insertBodyVar() { setBody((b) => `${b}{{${nVars + 1}}}`); setSamples((s) => [...s, ""]) }
        ...
        <div className="flex-1 overflow-hidden grid grid-cols-1 md:grid-cols-[1fr_330px] min-h-0">
          ...
          <div className="overflow-y-auto p-5 space-y-6">
            ...
            <Section title="Corpo" required>
              ...
              <Hint>Use *negrito*, _itálico_, ~tachado~. Não comece/termine com variável, nem use duas seguidas.</Hint>
            </Section>
